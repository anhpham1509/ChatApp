...
// GET group members
function listMembers(groupName) {
            ...
            $("ul#all-group").append("\
                <li class='left clearfix'>\
                    <div class='chat-body clearfix'>\
                        ...
                        \
                        <a href='#' data-toggle='tooltip' data-placement='right' title='Members: Join'>\
            ...
            $("ul#all-group").append("\
                <li class='left clearfix'>\
                    <div class='chat-body clearfix'>\
                        ...
                        \
                        <a href='#' data-toggle='tooltip' data-placement='right' title='Members: Leave'>\
                            <i class='fa fa-users'></i>" + quantity + "\
                        </a>\
                    </div>\
                </li>");
